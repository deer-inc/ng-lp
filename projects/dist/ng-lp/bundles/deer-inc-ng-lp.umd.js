(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@fortawesome/free-brands-svg-icons'), require('@angular/platform-browser'), require('safe-pipe'), require('@fortawesome/angular-fontawesome')) :
    typeof define === 'function' && define.amd ? define('@deer-inc/ng-lp', ['exports', '@angular/core', '@fortawesome/free-brands-svg-icons', '@angular/platform-browser', 'safe-pipe', '@fortawesome/angular-fontawesome'], factory) :
    (factory((global['deer-inc'] = global['deer-inc'] || {}, global['deer-inc']['ng-lp'] = {}),global.ng.core,global.freeBrandsSvgIcons,global.ng.platformBrowser,global.safePipe,global.angularFontawesome));
}(this, (function (exports,core,freeBrandsSvgIcons,platformBrowser,safePipe,angularFontawesome) { 'use strict';
    ...
    var NgLpComponent = /** @class */ (function () {
        function NgLpComponent() {
            this.handleClickAction = new core.EventEmitter();
            this.faGithub = freeBrandsSvgIcons.faGithub;
            this.faTwitter = freeBrandsSvgIcons.faTwitter;
            this.faFacebook = freeBrandsSvgIcons.faFacebook;
        }
        /**
         * @return {?}
         */
        ...
        NgLpComponent.propDecorators = {
            handleClickAction: [{ type: core.Output }],
    ...
    exports.NgLpModule = NgLpModule;
    exports.ɵa = NgLpComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=deer-inc-ng-lp.umd.js.map